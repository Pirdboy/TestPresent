...
- (UIImage *)roundedCornerImage:(NSInteger)cornerSize borderSize:(NSInteger)borderSize
{
    ...
    [self pr_addRoundedRectToPath:CGRectMake(borderSize, borderSize,
    ...
    // Draw the image to the context; the clipping path will make anything outside the rounded rect
    // transparent
...
- (void)pr_addRoundedRectToPath:(CGRect)rect
