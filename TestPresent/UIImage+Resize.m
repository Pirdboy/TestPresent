...
// If transparentBorder is non-zero, a transparent border of the given size will be added around the
// edges of the thumbnail. (Adding a transparent border of at least one pixel in size has the
// side-effect of antialiasing the edges of the image when rotating it using Core Animation.)
       ...
       interpolationQuality:(CGInterpolationQuality)quality
{
    ...
    UIImage *transparentBorderImage =
        borderSize ? [croppedImage transparentBorderImage:borderSize] : croppedImage;
...
// Resizes the image according to the given content mode, taking into account the image's
// orientation
